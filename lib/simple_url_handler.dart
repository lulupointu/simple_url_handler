...
class SimpleUrlHandler extends StatelessWidget {
  ...
  /// You should reconstruct your app state from the [routeInformation].
  ///
  /// This is where you should do any check to see if the user is trying to access a
  /// url that he is not supposed to.
...
class SimpleUrlNotifier extends InheritedWidget {
...
class SimpleRouterDelegate extends RouterDelegate<RouteInformation>
  ...
  @override
  Future<void> setNewRoutePath(RouteInformation routeInformation) =>
      urlToAppState(context, routeInformation);
